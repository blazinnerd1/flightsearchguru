...
export class FlightFilter extends React.Component {
  constructor(props) {
    ...
    const { filterByPrice, stops, priceLow, priceHigh, sortBy, destinations } = props.flightfilter;
...
FlightFilter.propTypes = {
  updateFiter: PropTypes.func.isRequired,
  flightfilter: PropTypes.object,
  
};

const mapStateToProps = createStructuredSelector({
  flightfilter: makeSelectFilters(),
